            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{
                ...
                <p>
                  ...
                  {selectedCase.hospitalPrep?.department || 'Emergency'}
                </p>

                <p>
                  <strong>Priority:</strong>{' '}
                  {selectedCase.hospitalPrep?.priority || 'STANDARD'}
                </p>

                <p>
                  <strong>Equipment:</strong>{' '}
                  {selectedCase.hospitalPrep?.equipmentNeeded?.join(', ') || 'Basic ER Setup'}
                </p>

                <p>
                  <strong>Medications:</strong>{' '}
                  {selectedCase.hospitalPrep?.medicationsToPrep?.join(', ') || 'Standard meds'}
                </p>

                <p>
                  <strong>Staff:</strong>{' '}
                  {selectedCase.hospitalPrep?.staffToCall?.join(', ') || 'ER team'}
                </p>

                <p>
                  <strong>Instructions:</strong>{' '}
                  {selectedCase.hospitalPrep?.immediateActions || 'Prepare patient arrival'}
                </p>
              </div>
